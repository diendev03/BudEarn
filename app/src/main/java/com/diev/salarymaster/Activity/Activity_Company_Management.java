...
public class Activity_Company_Management extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setControl();
        setEvent();
        adapter_company = new Adapter_Company(this, userId,progressBar);
        rcv_listCompany.setAdapter(adapter_company); // Thêm adapter vào RecyclerView
    }
    ...
    private void setControl() {
        ...
        progressBar = findViewById(R.id.progressBar_company_management);
    }
}